  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        'Customer and vendor master data with bulk import and export',
        'Inventory management with items, stock and goods transfers',
        ...
        'Multi-user access with roles, permissions and authorisation control',
        'English and Khmer interface',
      ],
      // Prices mirror https://vithean.com/en/pricing/ — keep the two in sync.
      offers: {
        '@type': 'AggregateOffer',
        ...
        offers: [
          {
            ...
            eligibleQuantity: { '@type': 'QuantitativeValue', value: 2, unitText: 'users' },
            priceSpecification: {
          ...
          },
          {
            ...
            url: 'https://vithean.com/en/pricing/',
            availability: 'https://schema.org/InStock',
            eligibleQuantity: { '@type': 'QuantitativeValue', value: 3, unitText: 'users' },
            priceSpecification: {
              '@type': 'UnitPriceSpecification',
              price: 25,
              priceCurrency: 'USD',
          ...
          },
          {
            ...
            url: 'https://vithean.com/en/pricing/',
            availability: 'https://schema.org/InStock',
            eligibleQuantity: { '@type': 'QuantitativeValue', value: 5, unitText: 'users' },
            priceSpecification: {
              '@type': 'UnitPriceSpecification',
              price: 45,
              priceCurrency: 'USD',
      ...
      // 30-day free trial, advertised on the pricing and sign-up pages.
      potentialAction: {
        '@type': 'ConsumeAction',
        name: '30-day free trial',
        target: 'https://app.vithean.com/signup/packages',
      },
